...
public class IbanValidationServiceTest {
    ...
    private static final Iban TEST_IBAN = new Iban("XX12"); // meets minimal pattern requirements
    private static final int NUMBER_OF_CONFIGURED_VALIDATIONS = 2; // see configuration file in test resources
